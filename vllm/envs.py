...
if TYPE_CHECKING:
    ...
    VLLM_MXFP8_MOE_NVTX: bool = False
...
environment_variables: dict[str, Callable[[], Any]] = {
    ...
    # Add optional MXFP8 MoE backend NVTX scopes for profiling.
    "VLLM_MXFP8_MOE_NVTX": lambda: bool(
        int(os.getenv("VLLM_MXFP8_MOE_NVTX", "0"))
    ),
